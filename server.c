...
int main(int argc, char **argv) {
    ...
    while (true) {
        ...
        // put the connection somewhere so an available thread can find it
        ...
        *pclient = client_socket;
        ...
        // pthread_create(&handle_connection_thread, NULL, handle_connection, pclient);
        // pthread_join(handle_connection_thread, NULL);
